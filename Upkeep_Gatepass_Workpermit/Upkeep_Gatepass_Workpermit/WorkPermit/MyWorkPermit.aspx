<%@ Page Title="" Language="C#" MasterPageFile="~/UpkeepMaster.Master" AutoEventWireup="true" CodeBehind="MyWorkPermit.aspx.cs" Inherits="Upkeep_Gatepass_Workpermit.WorkPermit.MyWorkPermit" %>
                ...
                <div class="m-portlet m-portlet--mobile">
                    <div class="m-portlet__head">
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                            <a href="<%= Page.ResolveClientUrl("~/WorkPermit/WorkPermit_Request.aspx") %>" style="margin-top: 5%;" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                <span>
                        ...
                        <table class="m-datatable" id="html_table" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th title="WorkPermit Date" data-field="GPDate">Work Permit Date</th>
