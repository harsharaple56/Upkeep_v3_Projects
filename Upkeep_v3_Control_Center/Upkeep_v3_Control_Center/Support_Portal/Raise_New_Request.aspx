<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Raise_New_Request.aspx.cs" Inherits="Upkeep_v3_Control_Center.Support_Portal.Raise_New_Request" %>
                                ...
                                <div class="col-xl-12">
                                    <div class="m-form__section m-form__section--first">
                                        ...
                                        <div class="form-group m-form__group row" style="padding-bottom: 0px;">
                                            ...
                                            <div class="col-xl-3 col-lg-4">
                                                <asp:DropDownList ID="ddlcompanyName" class="form-control m-input" runat="server" OnSelectedIndexChanged="ddlcompanyName_SelectedIndexChanged" AutoPostBack="true">
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlModule" ValidationGroup="ValidateRequest"
                                                    ErrorMessage="Please select Company where Issue is occuring" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                            </div>

                                            <div class="col-xl-7 col-lg-4">
                                                <div class="alert m-alert m-alert--default" role="alert">
                                                    Select Company where Issue is occuring.
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group m-form__group row" style="padding-bottom: 0px;">
                                            ...
                                            <label class="col-xl-2 col-lg-2 col-form-label"><span style="color: red;">*</span> Select User :</label>
                                            <div class="col-xl-3 col-lg-4">
                                                <asp:DropDownList ID="ddlUser" class="form-control m-input" runat="server">
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlModule" ValidationGroup="ValidateRequest"
                                                    ErrorMessage="Please select user who raised the issue" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                            </div>

                                            <div class="col-xl-7 col-lg-4">
                                                <div class="alert m-alert m-alert--default" role="alert">
                                                    Select user who raised the issue.
                                                </div>
                                            </div>
