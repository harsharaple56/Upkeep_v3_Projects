                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <label for="message-text" class="col-xl-6 col-lg-3 form-control-label font-weight-bold">Asset ID :</label>
                                                    <asp:Label ID="lblWpRequestCode" Text="" runat="server" CssClass="col-xl-6 col-lg-3 col-form-label" Style="padding-top: calc(0.15rem + 1px); text-align: Left"></asp:Label>
                                                </div>
                                            </div>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="ClsControlTd">
                                                                <asp:UpdatePanel ID="Updatepanel4" runat="server" UpdateMode="Always">
                                                                    <ContentTemplate>
                                                                        <asp:GridView DataKeyNames="Asset_Type_ID" ID="grd_AssetType" CssClass="ct-grid" runat="server"
                                                                            Width="100%" AllowPaging="true"
                                                                            PageSize="10" AllowSorting="true" HeaderStyle-BackColor="#2E5E79"
                                                                            ...
                                                                            PagerSettings-Position="Bottom" ClientIDMode="Static" OnPageIndexChanging="grd_AssetType_PageIndexChanging"
                                                                    ...
                                                                    <Triggers>
                                                                        <asp:AsyncPostBackTrigger ControlID="grd_AssetType" />
                                                                    </Triggers>
                                                                </asp:UpdatePanel>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="ClsControlTd">
                                                                <asp:UpdatePanel ID="Updatepanel5" runat="server" UpdateMode="Always">
                                                                    <ContentTemplate>
                                                                        <asp:GridView DataKeyNames="Asset_Category_ID" ID="GridView1" CssClass="ct-grid" runat="server"
                                                                            Width="100%" AllowPaging="true" AutoGenerateColumns="False" 
                                                                            PageSize="10" AllowSorting="true" HeaderStyle-BackColor="#2E5E79"
                                                                            HeaderStyle-ForeColor="white" CellPadding="5" AlternatingRowStyle-BackColor="#E7F3FF"
                                                                            PagerStyle-HorizontalAlign="Center" PagerStyle-Mode="NumericPages" PagerSettings-Mode="Numeric"
                                                                            PagerSettings-Position="Bottom" ClientIDMode="Static" OnPageIndexChanging="GridView1_PageIndexChanging"
                                                                            OnRowDataBound="GridView1_RowDataBound" OnRowEditing="GridView1_RowEditing" OnRowCancelingEdit="GridView1_RowCancelingEdit"
                                                                            OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting" EmptyDataText="No records has been added."
                                                                            AutoGenerateEditButton="true" AutoGenerateDeleteButton="true">
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Asset Type">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("Asset_Type_Desc") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="Asset Category">
                                                                                    <EditItemTemplate>
                                                                                        <asp:TextBox  ID="TextBox2" runat="server" Text='<%# Bind("Category_Desc") %>'>  
                                                                                        </asp:TextBox>
                                                                                    </EditItemTemplate>
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("Category_Desc") %>'>  
                                                                                        </asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
