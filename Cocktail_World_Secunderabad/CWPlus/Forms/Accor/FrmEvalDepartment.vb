Public Class FrmEvalDepartment
    Dim ObjDept As CWPlusBL.Accor.ClsEvalDepartment
...
#Region "Procedures"
    ...
    Private Sub InitScreen()
        Try
            ObjDept = New CWPlusBL.Accor.ClsEvalDepartment
            ObjDt = New DataTable
    ...
    Public Function Save() As Boolean
        ...
        Try
            ...
            ObjDept.EvalDepartmentDesc = txtDepartment.Text
            ObjDept.EvalDepartmentCode = txtDeptCode.Text
