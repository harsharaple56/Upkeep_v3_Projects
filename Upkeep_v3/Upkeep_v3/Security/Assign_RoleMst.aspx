<%@ Page Title="" Language="C#" MasterPageFile="~/UpkeepMaster.Master" AutoEventWireup="true" CodeBehind="Assign_RoleMst.aspx.cs" Inherits="Upkeep_v3.Security.Assign_RoleMst" %>
                                        ...
                                        <Columns>
                                            <asp:TemplateField >
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="hdnEmployeeID" runat="server" Value='<%#Eval("User_ID") %>'/>
                                                    
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:BoundField DataField="User_ID" HeaderText="EmployeeID" ItemStyle-Width="150" Visible="false" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
                                            <asp:BoundField DataField="User_Code" HeaderText="Employee Code" ItemStyle-Width="150" />
                                            <asp:BoundField DataField="Name" HeaderText="Name" ItemStyle-Width="150" />
                                            <asp:BoundField DataField="CompanyID" HeaderText="Company" ItemStyle-Width="150" />
                                            ...
                                            <asp:BoundField DataField="User_Designation" HeaderText="Designation" ItemStyle-Width="150" />
