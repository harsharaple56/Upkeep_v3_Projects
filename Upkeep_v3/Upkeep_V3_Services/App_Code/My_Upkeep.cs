...
public class My_Upkeep
{
    ...
    public DataSet Insert_LocationTree(string parentNode, string childNode, string emptyParentNode,string rowColumnNumber, int CompanyID, string LoggedInUserID)
    {
        try
        {
            ...
            ds = ObjUpkeepCC_BL.Insert_LocationTree(parentNode, childNode, emptyParentNode, rowColumnNumber, CompanyID, LoggedInUserID, StrConn);
            return ds;
        }
        catch (Exception ex)
        {
    ...
    public DataSet Import_DepartmentList_Master(int CompanyID, string LoggedInUserID)
    {
        ...
        try
        {
            StrConn = ConfigurationManager.ConnectionStrings["Upkeep_ConString"].ConnectionString.ToString();
            string strOutput = string.Empty;
            dsAddChecklist = ObjUpkeepCC_BL.Import_DepartmentList_Master(CompanyID, LoggedInUserID, StrConn);
    ...
    public DataSet Insert_WorkPermitConfiguration(string strConfigTitle, int CompanyID, string strInitiator, bool LinkDepartment, string strTransactionPrefix, string strXmlWorkPermit_Header, string strXmlWorkPermit_TermCondition, string strXmlApprovalMatrix, bool chkShowApprovalMatrix_Initiator, bool chkShowApprovalMatrix_Approver, string WPNotify_Emails, string LoggedInUserID)
    {
        ...
        try
        {
            StrConn = ConfigurationManager.ConnectionStrings["Upkeep_ConString"].ConnectionString.ToString();
            string strOutput = string.Empty;
            ds = ObjUpkeepCC_BL.Insert_WorkPermitConfiguration(strConfigTitle, CompanyID, strInitiator, LinkDepartment, strTransactionPrefix, strXmlWorkPermit_Header, strXmlWorkPermit_TermCondition, strXmlApprovalMatrix, chkShowApprovalMatrix_Initiator, chkShowApprovalMatrix_Approver, WPNotify_Emails, LoggedInUserID, StrConn);
            return ds;
        }
        catch (Exception ex)
        {
    ...
    public DataSet Fetch_WorkPermitRequestData_PDF(int WP_ConfigID, string Transaction_ID, string LoggedInUserID)
    {
        ...
        try
        {
            StrConn = ConfigurationManager.ConnectionStrings["Upkeep_ConString"].ConnectionString.ToString();
            string strOutput = string.Empty;
            ds = ObjUpkeepCC_BL.Fetch_WorkPermitRequestData_PDF(WP_ConfigID, Transaction_ID, LoggedInUserID, StrConn);
            return ds;
        }
        catch (Exception ex)
        {
    ...
    public DataSet Update_WorkPermitConfiguration(int WP_Config_ID, string strConfigTitle, int CompanyID, string strInitiator, bool LinkDepartment, string strTransactionPrefix, string strXmlWorkPermit_Header, string strXmlWorkPermit_TermCondition, string strXmlApprovalMatrix, bool chkShowApprovalMatrix_Initiator, bool chkShowApprovalMatrix_Approver, string WPNotify_Emails, string LoggedInUserID)
    {
        ...
        try
        {
            StrConn = ConfigurationManager.ConnectionStrings["Upkeep_ConString"].ConnectionString.ToString();
            string strOutput = string.Empty;
            ds = ObjUpkeepCC_BL.Update_WorkPermitConfiguration(WP_Config_ID, strConfigTitle, CompanyID, strInitiator, LinkDepartment, strTransactionPrefix, strXmlWorkPermit_Header, strXmlWorkPermit_TermCondition, strXmlApprovalMatrix, chkShowApprovalMatrix_Initiator, chkShowApprovalMatrix_Approver, WPNotify_Emails, LoggedInUserID, StrConn);
            return ds;
        }
        catch (Exception ex)
        {
    ...
    public DataSet Fetch_Asset_DropDown(int UserID, int CompanyID, int TypeID, string Type_Desc, string CategoryTypeID, string Action)
    {
        ...
        {
            StrConn = ConfigurationManager.ConnectionStrings["Upkeep_ConString"].ConnectionString.ToString();
            ds = ObjUpkeepCC_BL.Fetch_Asset_DropDown(UserID, CompanyID, TypeID, Type_Desc, CategoryTypeID, Action, StrConn);
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    public DataSet Insert_System_Setting_Ticket_QR(int CompanyID)
    {
        ...
        {
            StrConn = ConfigurationManager.ConnectionStrings["Upkeep_ConString"].ConnectionString.ToString();
            ds = ObjUpkeepCC_BL.Insert_System_Setting_Ticket_QR(CompanyID, StrConn);
        }
        catch (Exception ex)
        {
            throw ex;
