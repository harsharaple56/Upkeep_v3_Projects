...
namespace Upkeep_v3.Upkeep_V3_Services {
    ...
    public partial class Upkeep_V3_Services : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public System.Data.DataSet Crud_Inv_Category_Mst(string LoggedInUserID, string CompanyID, string CategoryID, string CategoryDesc, string Action) {
        ...
        /// <remarks/>
        public void Crud_Inv_Category_MstAsync(string LoggedInUserID, string CompanyID, string CategoryID, string CategoryDesc, string Action) {
            this.Crud_Inv_Category_MstAsync(LoggedInUserID, CompanyID, CategoryID, CategoryDesc, Action, null);
        }
        
        /// <remarks/>
        public void Crud_Inv_Category_MstAsync(string LoggedInUserID, string CompanyID, string CategoryID, string CategoryDesc, string Action, object userState) {
        ...
        public System.Data.DataSet Crud_Inv_SubCategory_Mst(string LoggedInUserID, string CompanyID, string CategoryID, string SubCategoryID, string SubCategoryDesc, string Action) {
        ...
        /// <remarks/>
        public void Crud_Inv_SubCategory_MstAsync(string LoggedInUserID, string CompanyID, string CategoryID, string SubCategoryID, string SubCategoryDesc, string Action) {
            this.Crud_Inv_SubCategory_MstAsync(LoggedInUserID, CompanyID, CategoryID, SubCategoryID, SubCategoryDesc, Action, null);
        }
        
        /// <remarks/>
        public void Crud_Inv_SubCategory_MstAsync(string LoggedInUserID, string CompanyID, string CategoryID, string SubCategoryID, string SubCategoryDesc, string Action, object userState) {
        ...
        public System.Data.DataSet Crud_Inv_Item_Mst(string LoggedInUserID, string CompanyID, string CategoryID, string SubCategoryID, string ItemID, string ItemDesc, string Action) {
        ...
        /// <remarks/>
        public void Crud_Inv_Item_MstAsync(string LoggedInUserID, string CompanyID, string CategoryID, string SubCategoryID, string ItemID, string ItemDesc, string Action) {
            this.Crud_Inv_Item_MstAsync(LoggedInUserID, CompanyID, CategoryID, SubCategoryID, ItemID, ItemDesc, Action, null);
        }
        
        /// <remarks/>
        public void Crud_Inv_Item_MstAsync(string LoggedInUserID, string CompanyID, string CategoryID, string SubCategoryID, string ItemID, string ItemDesc, string Action, object userState) {
