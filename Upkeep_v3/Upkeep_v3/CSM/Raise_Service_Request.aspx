						...
						<div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
							...
							<div class="m-portlet__body" style="padding: 0.4rem 2.2rem;">
								...
								<div class="m-portlet__body" style="padding: 0.3rem 2.2rem;">
									<div class="form-group m-form__group row" style="padding-left: 1%;" id="divRequest" runat="server" visible="false">
										<div class="col-md-6">
											<label class="col-md-4 col-form-label font-weight-bold">Requested By :</label>
												<asp:Label class="col-md-8" ID="lblRequestedBy" runat="server" ClientIDMode="Static"></asp:Label>
										</div>
										<div class="col-md-6">
											<label class="col-md-4 col-form-label font-weight-bold">Requested Date :</label>
												<asp:Label class="col-md-8" ID="lblRequestedDate" runat="server" ClientIDMode="Static"></asp:Label>
										</div>
									</div>
									<hr />
									<div class="form-group m-form__group row" style="padding-left: 1%;" id="divClosed" runat="server" visible="false">
										<div class="col-md-6">
											<label class="col-md-4 col-form-label font-weight-bold">Closed By :</label>
												<asp:Label class="col-md-8" ID="lblClosedBy" runat="server" ClientIDMode="Static"></asp:Label>
										</div>
										<div class="col-md-6">
											<label class="col-md-4 col-form-label font-weight-bold">Closed Date :</label>
												<asp:Label class="col-md-8" ID="lblClosedDate" runat="server" ClientIDMode="Static"></asp:Label>
										</div>
									</div>
