...
{
    public partial class Department_Checklists : System.Web.UI.Page
    {
        ...
        public string fetchChkReportListing()
        {
            ...
            try
            {
                ...
                ds = ObjUpkeep.Fetch_My_Department_Checklists(LoggedInUserID, Session["CompanyID"].ToString(), From_Date, To_Date);
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            data += "<tr><td> <a href='CheckList_Report_Details.aspx?Ans_Response_ID=" + Ans_Response_ID + "' style='text-decoration: underline;' > " + Chk_Response_No + " </a></td>" +
                                "<td>" + ChecklistName + "</td>" + "<td>" + Department + "</td>" +
                                "<td>" + Location + "</td>" +
                                "<td>" + Status + "</td>" +
                                "<td>" + StartTime + "</td>" +
                                "<td>" + EndTime + "</td>" +
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dsReport = ObjUpkeep.Fetch_My_Department_Checklists(LoggedInUserID, Session["CompanyID"].ToString(), From_Date, To_Date);
