...
Public Class FrmVoidDiscSummary
    ...
    Private Sub btnok_Click(sender As System.Object, e As System.EventArgs) Handles btnok.Click
        Try
            ...
            ObjPriDt = ObjCls.FunFetchVoidDiscountSummary()
    ...
    Private Sub btnCrystalReport_Click(sender As System.Object, e As System.EventArgs) Handles btnCrystalReport.Click
        ...
        GenerateReport("voiddisc", "proc#" & "Spr_FetchVoidDiscountSummary" & "#" & StrParam & vbCrLf & "changeremarks.rpt")
        'GenerateReport("costvsslaes", "proc#" & "Spr_FetchCostvsSales" & "#" & StrParam & vbCrLf & "Costvssale2")
    End Sub

    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        SaveVoid(0, dtFromDate.Value, dtToDate.Value, DirectCast(grdDCCReport.DataSource, DataTable), 1)
    End Sub

    Private Sub BtnRptDetailed_Click(sender As System.Object, e As System.EventArgs) Handles BtnRptDetailed.Click
        Dim StrParam As String = ""
        StrParam = "'" & Format(dtFromDate.Value, "dd-MMM-yyyy") & "','" & Format(dtToDate.Value, "dd-MMM-yyyy") & "'"
        GenerateReport("VoidDetailed", "proc#" & "Spr_FetchVoidDetailed" & "#" & StrParam)
        'GenerateReport("costvsslaes", "proc#" & "Spr_FetchCostvsSales" & "#" & StrParam & vbCrLf & "Costvssale2")
    End Sub
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        Dim StrParam As String = ""
        StrParam = "'" & Format(dtFromDate.Value, "dd-MMM-yyyy") & "','" & Format(dtToDate.Value, "dd-MMM-yyyy") & "'"
        GenerateReport("DiscountDetailed", "proc#" & "Spr_FetchNonPromotionalMealv2" & "#" & StrParam)
        'GenerateReport("costvsslaes", "proc#" & "Spr_FetchCostvsSales" & "#" & StrParam & vbCrLf & "Costvssale2")
    End Sub

    Private Sub FrmVoidDiscSummary_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
