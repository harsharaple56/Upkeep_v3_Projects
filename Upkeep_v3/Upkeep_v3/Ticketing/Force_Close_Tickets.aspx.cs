...
{
    public partial class Force_Close_Tickets : System.Web.UI.Page
    {
        ...
        public void Fetch_CTT_Report()
        {
            ...
            try
            {
                ...
                dsCTT = ObjUpkeep.Fetch_Force_Close_Ticket_List(TicketStatus, ActionStatus, From_Date, To_Date, CompanyID);
            ...
            try
            {
                ...
                if (dsExport.Tables.Count > 0)
                {
                    if (dsExport.Tables[0].Rows.Count > 0)
                    {
                        ...
                        string filename = "Force Close Ticket List As On " + currentDate + ".xls";

                        string HeaderText = "Force Close Ticket List As On " + currentDate;
        ...
        protected void gvCTT_Report_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "ViewTicket")
            {
                ...
                Response.Redirect(Page.ResolveClientUrl("~/Ticketing/Force_Close_Ticket_Details.aspx?TicketID=" + TicketID), false);
            }
        }
