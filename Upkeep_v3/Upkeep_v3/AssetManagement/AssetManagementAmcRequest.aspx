<%@ Page Title="" Language="C#" MasterPageFile="~/UpkeepMaster.Master" AutoEventWireup="true" CodeBehind="AssetManagementAmcRequest.aspx.cs" Inherits="Upkeep_Gatepass_Workpermit.AssetManagement.AssetManagementAmcRequest" %>
                            ...
                            <div class="m-portlet__head-wrapper">
                                <div class="m-portlet__head-caption">
                                    <div class="m-portlet__head-title">
                                        <h3 class="m-portlet__head-text">Asset Management AMC</h3>
                                    </div>
                                </div>
                                                    ...
                                                    <table class="m-datatable" id="html_table" width="100%">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th title="Asset_AMC_Type" data-field="Asset_AMC_Type_Desc">AMC_Type</th>
                                                                <th title="AMC_Desc" data-field="AMC_Desc">Description</th>
                                                                <th title="Start_Date" data-field="AMC_Start_Date">Start_Date</th>
                                                                <th title="End_Date" data-field="AMC_End_Date">End_Date</th>
                                                                <th title="Vendor_Name" data-field="Vendor_Name">Vendor_Name</th>
                                                                <th title="Inclusions" data-field="AMC_Inclusions">Inclusions</th>
                                                                <th title="Exclusions" data-field="AMC_Exclusions">Exclusions</th>
                                                                <th title="Remarks" data-field="Additional Remarks">Remarks</th>
                                                                <th title="Status" data-field="AMC_Status">Status</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <%=fetchListing()%>
