...
Public Class FrmKarnatakBulkBeer
    ...
    Private Sub btnok_Click(sender As System.Object, e As System.EventArgs) Handles btnok.Click
        ...
        Try
            ...
            ObjDt = ObjApBang.FunFetchBulkBeer(IIf(txtTimeOut.Text = "", 30, CInt(txtTimeOut.Text)))
    ...
    Private Sub btnCrystalReport_Click(sender As System.Object, e As System.EventArgs) Handles btnCrystalReport.Click
        ...
        GenerateReport("bulkbeer", "proc#" & "Spr_FetchBulkBeer" & "#" & StrParam & "#" & txtTimeOut.Text & vbCrLf & "bulkbeerTP.rpt")
    End Sub
    ...
    '    GenerateReport("bangloremonthly-TP", "proc#" & "Spr_FetchBulkBeer" & "#" & StrParam & "#" & txtTimeOut.Text)
    'End Sub
