<%@ Page Title="" Language="C#" MasterPageFile="~/UpkeepMaster.Master" AutoEventWireup="true" CodeBehind="AssetManagementServiceList.aspx.cs" Inherits="Upkeep_v3.AssetManagement.AssetManagementServiceList" %>
            ...
            <div class="m-content">
                <div class="m-portlet m-portlet--mobile">
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text"> My Asset Management Services</h3>
                            </div>
                        </div>

                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                            <a href="<%= Page.ResolveClientUrl("~/AssetManagement/AssetManagementServiceRequest.aspx") %>" style="margin-top: 5%;" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                <span>
                    ...
                    <div class="m-portlet__body">
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable m-datatable__table" id="m_table_1">
                        <thead>
                            <tr>
