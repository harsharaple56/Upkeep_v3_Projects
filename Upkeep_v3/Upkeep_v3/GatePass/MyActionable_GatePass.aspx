<%@ Page Title="" Language="C#" MasterPageFile="~/UpkeepMaster.Master" AutoEventWireup="true" CodeBehind="MyActionable_GatePass.aspx.cs" Inherits="Upkeep_v3.GatePass.MyActionable_GatePass" %>
...

                        {
                            field: "Status", title: "Status", template: function (e) {
                                var t =
                                {
                                    ...
                                    "Return Approval Pending": { title: "Return Approval Pending", class: "m-badge--warning" },
                                    "Returnable Pending": { title: "Returnable Pending", class: "m-badge--warning" }
                ...
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">My Actionable Gate Pass Request		
                            </h3>
                        </div>
                    </div>
