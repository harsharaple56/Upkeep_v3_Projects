...
Public Class FrmAccorAdvMembership
    ...
    Private Sub btnok_Click(sender As System.Object, e As System.EventArgs) Handles btnok.Click
        Try
            ...
            ObjPriDt = ObjCls.FunFetchAccorAdvMembership()
    ...
    Private Sub btnCrystalReport_Click(sender As System.Object, e As System.EventArgs) Handles btnCrystalReport.Click
        ...
        GenerateReport("accoradvmem", "proc#" & "Spr_FetchAccorAdvMembership" & "#" & StrParam & "#100")
    End Sub
    ...
    Private Sub btnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            ObjExp.ExportToExcelHeaderFooterEval(IO.Path.GetTempPath, "temp.xls", "Accor Advantage Membership Report", ObjPriDts)
