...
#Region "Procedures"
    Public Sub BindGrid()
        ...
        ObjDt = objCocktail.FunFetchBrandListReport
        grdBrandOpening.DataSource = Nothing
        grdBrandOpening.DataSource = ObjDt
        MakeIDColumnsHide(grdBrandOpening)
        grdBrandOpening.Columns("brand").Width = 250
        grdBrandOpening.Columns("category").Width = 200
        lblCount.Text = "Number of brands : " & ObjDt.DefaultView.ToTable(True, "brand").Rows.Count
    End Sub
#End Region
    ...
    '    ObjDt = New DataTable
    '    ObjDt = DirectCast(grdBrandListReport.DataSource, DataTable)
