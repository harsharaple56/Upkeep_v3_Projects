<%@ Page Title="" Language="C#" MasterPageFile="~/UpkeepMaster.Master" AutoEventWireup="true" CodeBehind="Base_Quantity_Report.aspx.cs" Inherits="Upkeep_v3.Cocktail_World.Reports.Standard.Base_Quantity_Report" %>
                ...
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">Base Quantity Report</h3>
                        </div>
                    </div>
                ...
                <div class="m-portlet__body">
                    ...
                    <form class="m-form m-form--fit m--margin-bottom-20">
                        <div class="row m--margin-bottom-20 m--align-center">
                            ...
                            <div class="col-lg-4 m--margin-bottom-10-tablet-and-mobile">
                                <label class="font-weight-bold">Filter by Date:</label>
