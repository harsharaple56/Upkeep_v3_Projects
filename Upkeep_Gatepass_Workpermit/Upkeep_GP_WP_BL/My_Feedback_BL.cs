   ...
   public class My_Feedback_BL
    {
        ...
        public DataSet Retailer_CRUD(string storeName, string firstName, string lastName, string email, Int64 phone, int RetailerID, string Username, string Password, string LoggedInUserID, string actionType, string strConn)
        {
            DataSet ds = new DataSet();
            string strOutput = string.Empty;
        ...
        public DataSet ImportRetailer(string strConn)
        {
            DataSet ds = new DataSet();
            string strOutput = string.Empty;
        ...
        public DataSet FetchBaggageReport(string From_Date, string To_Date, string strConn)
        {
            DataSet ds = new DataSet();
            string strOutput = string.Empty;
            ...
            SqlCommand cmd = new SqlCommand("spr_FetchBaggageReportNew", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet FetchPowerBankReport(string From_Date, string To_Date, string strConn)
        {
            DataSet ds = new DataSet();
            string strOutput = string.Empty;
            ...
            SqlCommand cmd = new SqlCommand("spr_FetchPowerBankReport", con);
            cmd.CommandType = CommandType.StoredProcedure;
