...
Public Class FrmOfficerMeal
    ...
    Public Sub BindCheckData()
        Try
            ...
            grdDCCReport.Columns("Type").Visible = False
    ...
    Private Sub grdDCCReport_CellDoubleClick(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdDCCReport.CellDoubleClick
        ...
        Dim frmForm2 As New FrmAssignOfficerv2
    ...
    Private Sub btnCrystalReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCrystalReport.Click
        ...
        GenerateReport("nonpromtional-A", "proc#" & "Spr_FetchNonPromotionalMealv2" & "#" & StrParam)
    End Sub
    ...
    Private Sub BtnSummary_Click(sender As System.Object, e As System.EventArgs) Handles BtnSummary.Click
        ...
        ''GenerateReport("nonpromtionalsummary", "proc#" & "Spr_FetchNonPromotionalMealSummary" & "#" & StrParam)
        ...
        ObjExp.ExportToExcelHeaderFooter11(IO.Path.GetTempPath, "temp.xls", "Bhalya", ObjPriDs.Tables(0), ObjPriDs.Tables(1), ObjPriDs.Tables(2), ObjPriDs.Tables(3), ObjPriDs.Tables(4), ObjPriDs.Tables(5), ObjPriDs.Tables(6), ObjPriDs.Tables(7), ObjPriDs.Tables(8))
