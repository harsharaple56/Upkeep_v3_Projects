                            ...
                            <div class="m-tabs" data-tabs="true" data-tabs-contents="#m_sections">
                                <ul class="m-nav m-nav--active-bg m-nav--active-bg-padding-lg m-nav--font-lg m-nav--font-bold m--margin-bottom-20 m--margin-top-10 m--margin-right-40" id="m_nav" role="tablist">
                                    <li class="m-nav__item">
                                        <a class="m-nav__link m-tabs__item m-tabs__item--active" data-tab-target="#m_section_0" href="#">
                                    ...
                                    <li class="m-nav__item">
                                        <a class="m-nav__link m-tabs__item m-tabs__item" data-tab-target="#m_section_1" href="#">
                        ...
                        <div class="col-xl-9">
                            <div class="m-tabs-content" id="m_sections">
                                ...
                                <div class="m-tabs-content__item m-tabs-content__item--active" id="m_section_0">
                                    <h4 class="m--font-bold m--margin-top-15 m--margin-bottom-20">Getting Started & General Setup</h4>
                                    <div class="m-accordion m-accordion--section m-accordion--padding-lg" id="m_section_0_content">


                                        <!--begin::Item-->
                                        <span class="fa fa-video"></span>
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_0_content_1_head" data-toggle="collapse" href="#m_section_0_content_1_body">
                                                <span class="m-accordion__item-title">Getting Started</span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                            <div class="m-accordion__item-body collapse" id="m_section_0_content_1_body" role="tabpanel" aria-labelledby="m_section_0_content_1_head" data-parent="#m_section_1_content">
                                                <div class="m-accordion__item-content">

                                                    <video width="720" height="340" controls="controls">
                                                        <source src="https://compelapps.in/eFacilito_UAT/Knowledge_Base/Videos/Files/Getting_Started.mp4" type="audio/mp4" />
                                        ...
                                        <!--begin::Item-->
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_0_content_3_head" data-toggle="collapse" href="#m_section_0_content_3_body">
                                                <span class="m-accordion__item-title">Login Process</span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                            <div class="m-accordion__item-body collapse" id="m_section_0_content_3_body" role="tabpanel" aria-labelledby="m_section_0_content_3_head" data-parent="#m_section_1_content">
                                                <div class="m-accordion__item-content">
                                                    <p>
                                                        <h2>Login Process</h2>
                                        ...
                                        <!--begin::Item-->
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_0_content_4_head" data-toggle="collapse" href="#m_section_0_content_4_body">
                                                <span class="m-accordion__item-title">Forget Password</span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                            <div class="m-accordion__item-body collapse" id="m_section_0_content_4_body" role="tabpanel" aria-labelledby="m_section_0_content_4_head" data-parent="#m_section_1_content">
                                                <div class="m-accordion__item-content">
                                                    <p>
                                ...
                                <!--begin::Section 1-->
                                <div class="m-tabs-content__item m-tabs-content__item" id="m_section_1">
                                    <h4 class="m--font-bold m--margin-top-15 m--margin-bottom-20">Ticketing Setup & Instructions</h4>
                                    <div class="m-accordion m-accordion--section m-accordion--padding-lg" id="m_section_1_content">
                                        ...
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_1_content_1_head" data-toggle="collapse" href="#m_section_1_content_1_body">
                                                <span class="m-accordion__item-title">Configure Ticketing</span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                        ...
                                        <span class="fa fa-video"></span>
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_1_content_1a_head" data-toggle="collapse" href="#m_section_1_content_1a_body">
                                                <span class="m-accordion__item-title">Raising Tickets Tutorials </span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                            <div class="m-accordion__item-body collapse" id="m_section_1_content_1a_body" role="tabpanel" aria-labelledby="m_section_1_content_1_head" data-parent="#m_section_1_content">
                                                <div class="m-accordion__item-content">
                                                ...
                                                <div class="m-accordion__item-content">
                                                    ...
                                                    <p>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>WorkPermitSection : Click On + Sign The Three Boxes Will Get Display
                                                                <ol>
                                ...
                                <div class="m-tabs-content__item m-tabs-content__item" id="m_section_2">
                                    ...
                                    <div class="m-accordion m-accordion--section m-accordion--padding-lg" id="m_section_2_content">
                                        ...
                                        <div class="m-accordion__item">
                                            ...
                                            <div class="m-accordion__item-body collapse" id="m_section_2_content_1_body" role="tabpanel" aria-labelledby="m_section_1_content_1_head" data-parent="#m_section_1_content">
                                                <div class="m-accordion__item-content">
                                                    ...
                                                    <video width="740" height="380" controls="controls">
                                                        <source src="https://compelapps.in/eFacilito_UAT/Knowledge_Base/Videos/Files/Checklist_Configuration.mp4" type="audio/mp4" />
                                                        Your browser does not support the video tag.
                                                    </video>
                                                    <br />
                                                    </br>
                                        ...
                                        <div class="m-accordion__item">
                                            <span class="fa fa-video"></span>
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_2_content_1_head" data-toggle="collapse" href="#m_section_2_content_2_body">
                                                <span class="m-accordion__item-title">Attending Checklist Tutorial</span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                            <div class="m-accordion__item-body collapse" id="m_section_2_content_2_body" role="tabpanel" aria-labelledby="m_section_2_content_2_head" data-parent="#m_section_1_content">
                                                <div class="m-accordion__item-content">

                                                    <video width="740" height="380" controls="controls">
                                                        <source src="https://compelapps.in/eFacilito_UAT/Knowledge_Base/Videos/Files/Generate_Checklist.mp4" type="audio/mp4" />
                                                        Your browser does not support the video tag.
                                                    </video>
                                                    <br />
                                                    </br>
                                        ...
                                        <div class="m-accordion__item">
                                            ...
                                            <div class="m-accordion__item-body collapse" id="m_section_2_content_3_body" role="tabpanel" aria-labelledby="m_section_2_content_1_head" data-parent="#m_section_2_content">
                                                <div class="m-accordion__item-content">
                                        ...
                                        <div class="m-accordion__item">
                                            ...
                                            <div class="m-accordion__item-body collapse" id="m_section_5_content_1_body" role="tabpanel" aria-labelledby="m_section_5_content_1_head" data-parent="#m_section_5_content">
                                                <div class="m-accordion__item-content">
                                                    ...
                                                    <p>
                                                        <h6>When Any Event Organizied User Can Fill Online Form For FeedBack Instead Of Using Pen & Paper For FeedBack</h6>
                                                        <br />
                                    ...
                                    <div class="m-accordion m-accordion--section m-accordion--padding-lg" id="m_section_7_content">
                                        ...
                                        <div class="m-accordion__item">
                                            ...
                                            <div class="m-accordion__item-body collapse" id="m_section_7_content_2_body" role="tabpanel" aria-labelledby="m_section_7_content_2_head" data-parent="#m_section_7_content">
                                                <div class="m-accordion__item-content">
                                                    <p>
                                                        <h6>Create What All Things Needs To Mention/Asked When User Issue VMS</h6>
                                                        <br />
                                ...
                                <div class="m-tabs-content__item m-tabs-content__item" id="m_section_8">
                                    ...
                                    <div class="m-accordion m-accordion--section m-accordion--padding-lg" id="m_section_8_content">
                                        ...
                                        <span class="fa fa-video"></span>
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_8_content_0_head" data-toggle="collapse" href="#m_section_8_content_0_body">
                                                <span class="m-accordion__item-title">General Setup</span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                            <div class="m-accordion__item-body collapse" id="m_section_8_content_0_body" role="tabpanel" aria-labelledby="m_section_8_content_0_head" data-parent="#m_section_1_content">
                                                <div class="m-accordion__item-content">

                                                    <video width="740" height="380" controls="controls">
                                                        <source src="https://compelapps.in/eFacilito_UAT/Knowledge_Base/Videos/Files/General_Setup.mp4" type="audio/mp4" />
                                                        Your browser does not support the video tag.
                                                    </video>
                                                    <br />
                                                    </br>
                                        ...
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_8_content_1_head" data-toggle="collapse" href="#m_section_8_content_1_body">
                                                <span class="m-accordion__item-title">User Management </span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                            <div class="m-accordion__item-body collapse" id="m_section_8_content_1_body" role="tabpanel" aria-labelledby="m_section_8_content_1_head" data-parent="#m_section_8_content">
                                                <div class="m-accordion__item-content">
                                                    ...
                                                    <p>
                                                        <h6>In General SetUp User Can Create Departments , Can Create User By Creating There Unique Credential , Can Create Location Path Details & Etc. </h6>
                                                        <br />
                                        ...
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_8_content_2_head" data-toggle="collapse" href="#m_section_8_content_2_body">
                                                <span class="m-accordion__item-title">Location Mapping </span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                        ...
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_8_content_3_head" data-toggle="collapse" href="#m_section_8_content_3_body">
                                                <span class="m-accordion__item-title">Creating User Groups </span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                        ...
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_8_content_4_head" data-toggle="collapse" href="#m_section_8_content_4_body">
                                                <span class="m-accordion__item-title">Departments</span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                        ...
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_8_content_5_head" data-toggle="collapse" href="#m_section_8_content_5_body">
                                                <span class="m-accordion__item-title">Retailers</span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                        ...
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_8_content_8_head" data-toggle="collapse" href="#m_section_8_content_8_body">
                                                <span class="m-accordion__item-title">Vendors Data </span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
                                            <div class="m-accordion__item-body collapse" id="m_section_8_content_8_body" role="tabpanel" aria-labelledby="m_section_8_content_8_head" data-parent="#m_section_8_content">
                                                <div class="m-accordion__item-content">
                                                    ...
                                                    <p>
                                                        <h4>How To Create New Vendor Entry ?</h4>
                                                        <ul>
                                                            <li>Click On General SetUp</li>
                                        ...
                                        <div class="m-accordion__item">
                                            <div class="m-accordion__item-head collapsed" role="tab" id="m_section_8_content_9_head" data-toggle="collapse" href="#m_section_8_content_9_body">
                                                <span class="m-accordion__item-title">System Settings</span>
                                                <span class="m-accordion__item-mode"></span>
                                            </div>
