...
public class Upkeep_V3_Services : System.Web.Services.WebService
{
    ...
    public DataSet Send_Mail_Test(string Emails, string Subject, string HTML_Body)
    {
        try
        {
            ds = ObjUpkeep.Send_Mail_Test(Emails, Subject, HTML_Body);
    ...
    [WebMethod]
    public DataSet Import_DepartmentList_Master(int CompanyID, string LoggedInUserID)
    {
        DataSet ds = new DataSet();
        try
        {
            My_Upkeep obj = new My_Upkeep();
            ds = obj.Import_DepartmentList_Master(CompanyID, LoggedInUserID);
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    public DataSet Fetch_GP_Header_Data(int TransactionID, string GP_Header_Name)
    {
        ...
        try
        {
            ds = ObjUpkeep.Fetch_GP_Header_Data(TransactionID, GP_Header_Name);
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    public DataSet Fetch_MyActionableReturnableGatePass(int CompanyID, string LoggedInUserID, string From_Date, string To_Date)
    {
        ...
        try
        {
            ds = ObjUpkeep.Fetch_MyActionableReturnableGatePass(CompanyID, LoggedInUserID, From_Date, To_Date);
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    public DataSet Fetch_GatePassRequest_Approval_Details_Returnable(int TransactionID, string LoggedInUserID)
    {
        ...
        try
        {
            ds = ObjUpkeep.Fetch_GatePassRequest_Approval_Details_Returnable(TransactionID, LoggedInUserID);
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    public DataSet Insert_WorkPermitConfiguration(string strConfigTitle, int CompanyID, string strInitiator, bool LinkDepartment, string strTransactionPrefix, string strXmlWorkPermit_Header, string strXmlWorkPermit_TermCondition, string strXmlApprovalMatrix, bool chkShowApprovalMatrix_Initiator, bool chkShowApprovalMatrix_Approver, string WPNotify_Emails, string LoggedInUserID)
    {
        ...
        try
        {
            ds = ObjUpkeep.Insert_WorkPermitConfiguration(strConfigTitle, CompanyID, strInitiator, LinkDepartment, strTransactionPrefix, strXmlWorkPermit_Header, strXmlWorkPermit_TermCondition, strXmlApprovalMatrix, chkShowApprovalMatrix_Initiator, chkShowApprovalMatrix_Approver, WPNotify_Emails, LoggedInUserID);
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    public DataSet Update_WorkPermitConfiguration(int WP_Config_ID, string strConfigTitle, int CompanyID, string strInitiator, bool LinkDepartment, string strTransactionPrefix, string strXmlWorkPermit_Header, string strXmlWorkPermit_TermCondition, string strXmlApprovalMatrix, bool chkShowApprovalMatrix_Initiator, bool chkShowApprovalMatrix_Approver, string WPNotify_Emails, string LoggedInUserID)
    {
        ...
        try
        {
            ds = ObjUpkeep.Update_WorkPermitConfiguration(WP_Config_ID, strConfigTitle, CompanyID, strInitiator, LinkDepartment, strTransactionPrefix, strXmlWorkPermit_Header, strXmlWorkPermit_TermCondition, strXmlApprovalMatrix, chkShowApprovalMatrix_Initiator, chkShowApprovalMatrix_Approver, WPNotify_Emails, LoggedInUserID);
        }
        catch (Exception ex)
        {
            throw ex;
        ...
        string ToNo, int? ErrorCode, string ErrorMSg, int CompanyID, string LoggedInUserID)
    {
        ...
        try
        {
            ds = ObjUpkeep.Insert_WhatSappLog(ModuleType, RecordID, AccountSid,
                AuthToken, MsgSid, MsgBody, MsgStatus, FromNo,
                ToNo, ErrorCode, ErrorMSg, CompanyID, LoggedInUserID);
        }
        catch (Exception ex)
        {
            throw ex;
