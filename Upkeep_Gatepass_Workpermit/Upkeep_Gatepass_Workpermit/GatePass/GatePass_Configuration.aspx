<%@ Page Title="" Language="C#" MasterPageFile="~/UpkeepMaster.Master" AutoEventWireup="true" CodeBehind="GatePass_Configuration.aspx.cs" Inherits="Upkeep_Gatepass_Workpermit.GatePass.GatePass_Configuration" %>
                                ...
                                <div class="m-portlet__head-wrapper">
                                    ...
                                    <div class="m-portlet__head-tools" style="width: 28%;">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <asp:Button ID="btnSave" runat="server" class="btn btn-accent  m-btn m-btn--icon m-btn--wide m-btn--md" CausesValidation="true" ValidationGroup="validateGatePass" OnClientClick="return FunSetXML();" OnClick="btnSave_Click" Text="Save" />
