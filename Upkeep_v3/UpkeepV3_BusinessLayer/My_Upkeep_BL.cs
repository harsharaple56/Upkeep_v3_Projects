...
namespace UpkeepV3_BusinessLayer
{
    public class My_Upkeep_BL
    {
        ...
        public DataSet Fetch_Dashboard_Employee(int CompanyID, string LoggedInUserID, string Fromdate, string ToDate,int Module_Id,string Action, string StrConn)
        {
            try
            {
                string strOutput = string.Empty;
        ...
        public DataSet LMS_Save_Vendor_Transaction(int VendorID, int DepartmentID, string TransactionData, int CompanyID, string LoggedInUserID, string StrConn)
        {
            DataSet dsItem = new DataSet();
            try
            {
                string strOutput = string.Empty;
                SqlConnection con = new SqlConnection(StrConn);
                SqlCommand cmd = new SqlCommand("Spr_Save_LMS_Vendor_Transaction_Details", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet Fetch_LMS_Dept_Transaction_Details(int Dept_TransID, String StrConn)
        {
            try
            {
                string strOutput = string.Empty;
                SqlConnection con = new SqlConnection(StrConn);
                SqlCommand cmd = new SqlCommand("Spr_Fetch_LMS_Dept_Transaction_Details", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Dept_Trans_ID", Dept_TransID);
        ...
        public DataSet Fetch_LMS_Vendor_List(int CompanyID, string StrConn)
        {
            DataSet dsItem = new DataSet();
            try
            {
                string strOutput = string.Empty;
                SqlConnection con = new SqlConnection(StrConn);
                SqlCommand cmd = new SqlCommand("Spr_Fetch_LMS_Vendor_List", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@CompanyID", CompanyID);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dsItem);
        ...
        public DataSet Fetch_LMS_Vendor_Transaction_Details(int Vendor_TransID, String StrConn)
        {
            try
            {
                string strOutput = string.Empty;
                SqlConnection con = new SqlConnection(StrConn);
                SqlCommand cmd = new SqlCommand("Spr_Fetch_LMS_Vendor_Transaction_Details", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Vendor_Trans_ID", Vendor_TransID);
        ...
        public DataSet Fetch_Force_Close_Ticket_List(string TicketStatus, string ActionStatus, string From_Date, string To_Date, int CompanyID, string StrConn)
        {
            try
            {
                SqlConnection con = new SqlConnection(StrConn);
                SqlCommand cmd = new SqlCommand("Spr_Fetch_Force_Close_Ticket_List", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@TicketStatus", TicketStatus);
                cmd.Parameters.AddWithValue("@ActionStatus", ActionStatus);
                cmd.Parameters.AddWithValue("@From_Date", From_Date);
        ...
        public DataSet Save_Force_Close_Ticket(int TicketID, string Force_close_remarks, string LoggedInUserID, string StrConn)
        {
            try
            {
                SqlConnection con = new SqlConnection(StrConn);
                SqlCommand cmd = new SqlCommand("Spr_Ticket_Save_Force_Close", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@TicketID", TicketID);
                cmd.Parameters.AddWithValue("@Force_Closed_Remarks", Force_close_remarks);
                cmd.Parameters.AddWithValue("@LoggedInUserID", LoggedInUserID);
        ...
        public DataSet Fetch_Highest_Downtime_Ticket(string From_Date, string To_Date, int CompanyID, string StrConn)
        {
            ...
            {
                SqlConnection con = new SqlConnection(StrConn);
                SqlCommand cmd = new SqlCommand("Spr_Fetch_Highest_Downtime_Ticket", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@From_Date", From_Date);
                cmd.Parameters.AddWithValue("@To_Date", To_Date);
                cmd.Parameters.AddWithValue("@CompanyID", CompanyID);
        ...
        public DataSet Insert_Update_VMSConfiguration(int ConfigID, string strConfigTitle, string strConfigDesc, int CompanyID, string strInitiator, string strXmlVMS_Question, bool blFeedbackCompulsary, int FeedbackTitle, bool blEnableCovid, bool blChk_Vaccination, int EntryCount, bool blNameComp, bool blContactComp, bool blEmailComp, bool blMeetingComp, bool blEmailOtpComp, bool blContactOtpComp, string termsCondition,string NotifyEmails,bool Is_TimeLimit_Enabled,string FromTime,string ToTime,string SMS_Template_Details, string LoggedInUserID,  string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
                ...
                cmd.Parameters.AddWithValue("@EmailComp", blEmailComp);
                ...
                cmd.Parameters.AddWithValue("@SMS_Template_Details", SMS_Template_Details);
        ...
        public DataSet Insert_Update_CSMConfiguration(int ConfigID, string strConfigTitle, int CompanyID, string Description, string strXmlIn_Question, string strXmlOut_Question, string strXmlCSM_Terms, bool blFreeService, string CostUnit, string RequestFlowID, string LoggedInUserID, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
                ...
                cmd.Parameters.AddWithValue("@RequestFlowID", RequestFlowID);
        ...
        //Added by RC This function is used to Fetch CSM Request list
        public DataSet Fetch_CSMRequestList(int CompanyID, string LoggedInUserID, string From_Date, string To_Date, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
                SqlConnection con = new SqlConnection(StrConn);
                SqlCommand cmd = new SqlCommand("SPR_FETCH_CSM_REQUEST_LIST", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@CompanyID", CompanyID);
                cmd.Parameters.AddWithValue("@LoggedInUserID", LoggedInUserID);
                cmd.Parameters.AddWithValue("@From_Date", From_Date);
        ...
        public DataSet Bind_CSMRequestDetails(int RequestID, string LoggedInUserID, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
                SqlConnection con = new SqlConnection(StrConn);
                SqlCommand cmd = new SqlCommand("SPR_FETCH_CSM_REQUEST_DATA", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@RequestID", RequestID);
                cmd.Parameters.AddWithValue("@LoggedInUserID", LoggedInUserID);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
        ...
        public DataSet Insert_CSMRequest(int CompanyID, char Action, int RequestID, int ConfigID, string strCSMData, string LoggedInUserID, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
                SqlConnection con = new SqlConnection(StrConn);
                SqlCommand cmd = new SqlCommand("SPR_INSERT_CSM_REQUEST", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@CompanyID", CompanyID);
                cmd.Parameters.AddWithValue("@Action", Action);
                cmd.Parameters.AddWithValue("@RequestID", RequestID);
                cmd.Parameters.AddWithValue("@ConfigID", ConfigID);
                cmd.Parameters.AddWithValue("@CSMData", strCSMData);
                cmd.Parameters.AddWithValue("@LoggedInUserID", LoggedInUserID);
        ...
        public DataSet UPDATE_ASSET_CUSTOMFIELD_REQUEST_Details(string LoggedInUserID, string AssetXml, int TransactionID, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
                SqlConnection con = new SqlConnection(StrConn);
                SqlCommand cmd = new SqlCommand("SPR_ASSET_CUSTOMFIELD_UPDATE_REQUEST_DATA", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@LoggedInUserID", LoggedInUserID);
                cmd.Parameters.AddWithValue("@AssetXml", AssetXml);
                cmd.Parameters.AddWithValue("@AssetID", TransactionID);
        ...
        public DataSet Import_AssetList_Master(int CompanyID, string LoggedInUserID, string StrConn)
        {
            try
            {
                SqlConnection con = new SqlConnection(StrConn);
        ...
        public DataSet Fetch_VMSRequestList_Report_Excel(string EventID, int CompanyID, string From_Date, string To_Date, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
                SqlConnection con = new SqlConnection(StrConn);
                SqlCommand cmd = new SqlCommand("VMS_Proc_MIS_Report_Excel", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@EventID", EventID);
                cmd.Parameters.AddWithValue("@CompanyID", CompanyID);
                cmd.Parameters.AddWithValue("@From_Date", From_Date);
        ...
        public DataSet Fetch_Analyze_Tkt_Block1(string LoggedInUserID, int CompanyID,string FromDate,string ToDate, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
        ...
        public DataSet Fetch_Analyze_Tkt_Block2(string LoggedInUserID, int CompanyID, string FromDate, string ToDate, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
        ...
        public DataSet Fetch_Analyze_Tkt_Block3(string LoggedInUserID, int CompanyID, string FromDate, string ToDate, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
        ...
        public DataSet Fetch_Analyze_Tkt_Block4(string LoggedInUserID, int CompanyID, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
        ...
        public DataSet Fetch_Analyze_Tkt_Block5(string LoggedInUserID, int CompanyID, string FromDate, string ToDate, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
        ...
        public DataSet Fetch_Analyze_Tkt_Block6(string LoggedInUserID, int CompanyID, string FromDate, string ToDate, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
        ...
        public DataSet Fetch_Analyze_Tkt_Block7(string LoggedInUserID, int CompanyID, string FromDate, string ToDate, string StrConn)
        {
            DataSet ds = new DataSet();
            try
            {
