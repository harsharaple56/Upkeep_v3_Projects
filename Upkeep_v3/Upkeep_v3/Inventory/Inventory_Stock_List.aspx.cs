                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            data += "<tr>" +
                                ...
                                "<td>" + Sub_Category + "</td>" +
                                "<td>" + Balance + "</td>" +
                                "<td><a href='Inventory_Stock_Details.aspx?Stock_ID=" + Stock_ID + "' class='btn btn-accent m-btn m-btn--icon btn-sm m-btn--icon-only' data-container='body' data-toggle='m-tooltip' data-placement='top' title='Edit record'> <i class='la la-edit'></i> </a>  " +
