                            ...
                            <div class="m-portlet__body" style="padding: 0.4rem 2.2rem;">
                                ...
                                <div class="m-portlet__body" style="padding: 0.3rem 2.2rem;">
                                    <div class="form-group m-form__group row" style="padding-left: 1%;">
                                        <label class="col-xl-3 col-lg-2 form-control-label"><span style="color: red;">*</span> Work Permit Title :</label>
                                                    ...
                                                    <div class="form-group m-form__group row" style="padding-left: 1%;">
                                                        ...
                                                        <div class="col-xl-9 col-lg-9">
                                                            ...
                                                            <div id="divRadioButton" style="display: none" runat="server">
                                                                <asp:RadioButtonList class="m-radio-inline" runat="server" ID="divRadioButtonrdbYes" RepeatDirection="Horizontal" ValidationGroup="Radio" ClientIDMode="Static"  CellSpacing="1" CellPadding="1"></asp:RadioButtonList>
                                                            </div>
