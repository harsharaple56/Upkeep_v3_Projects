<%@ Page Title="" Language="C#" MasterPageFile="~/UpkeepMaster.Master" AutoEventWireup="true" CodeBehind="Vendor_Transactions.aspx.cs" Inherits="Upkeep_v3.Laundry_Management.Transactions.Vendor_Transactions" %>
                ...
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">Laundry Transactions with Vendors
                            </h3>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6 order-1 order-xl-2 m--align-right row">
                        ...
                        <div class="col-xl-6 col-lg-6">--%>
                            <a href="<%= Page.ResolveClientUrl("~/Laundry_Management/Transactions/Add_Vendor_Transaction.aspx") %>" style="margin-top: 5%;" class="btn btn-danger m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                <span>
