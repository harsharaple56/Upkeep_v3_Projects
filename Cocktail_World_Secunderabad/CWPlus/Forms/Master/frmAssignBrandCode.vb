...
#Region "Procedures"
            ...
            Try
                ...
                If gblArrMDICheckedLicense.Count > 0 Then
                    For cntr = 0 To gblArrMDICheckedLicense.Count - 1
                        ...
                        ObjAssignBrand = New CWPlusBL.Master.ClsAssignBrandCode
                        ObjAssignBrand.AssignBrandCodeID = lblassignbrandcodeid.Text
    ...
    Public Sub FetchAssignBrandCode()
        ...
        Finally
            ...
            End If
        End Try
        grdAssignBrandCode.Columns("CategorySizeLinkUpID").Visible = False
        grdAssignBrandCode.Columns("typeid").Visible = False
        grdAssignBrandCode.Columns("AssignBrandCodeID").Visible = False
...
#End Region
    ...
    Private Sub grdAssignBrandCode_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdAssignBrandCode.CellContentClick
        ...
        If e.ColumnIndex = 0 Then
            ...
            Try
                ObjAssignBrand = New CWPlusBL.Master.ClsAssignBrandCode
                ObjAssignBrand.AssignBrandCodeID = grdAssignBrandCode.Item("AssignBrandCodeID", e.RowIndex).Value
                ObjAssignBrand.LicenseID = MDI.cmbLicenseName.SelectedValue
                ObjAssignBrand.UserName = gblUserName
        ...
        ElseIf e.ColumnIndex = 1 Then
            ObjAssignBrand = New CWPlusBL.Master.ClsAssignBrandCode
            ObjDt = New DataTable
            ObjAssignBrand.BrandID = grdAssignBrandCode.Item("BrandId", e.RowIndex).Value
            ...
            If ObjDt.Rows.Count > 0 Then
                ...
                cmbSize.SelectedValue = ObjDt.Rows(0).Item("CategorySizeLinkUpID")
                If ObjDt.Rows(0).Item("TypeID") = 1 Then
                    txtbottle.Text = ObjDt.Rows(0).Item("BrandCode")
                ElseIf ObjDt.Rows(0).Item("TypeID") = 2 Then
                    txtspeg.Text = ObjDt.Rows(0).Item("BrandCode")
                ElseIf ObjDt.Rows(0).Item("TypeID") = 3 Then
                    txtlpeg.Text = ObjDt.Rows(0).Item("BrandCode")
                End If
                lblassignbrandcodeid.Text = grdAssignBrandCode.Item("AssignBrandCodeID", e.RowIndex).Value
            End If
