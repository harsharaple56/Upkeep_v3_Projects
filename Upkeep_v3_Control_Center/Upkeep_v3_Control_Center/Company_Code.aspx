<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Company_Code.aspx.cs" Inherits="Upkeep_v3_Control_Center.Company_Code" %>
					...
					<div class="m-login__container">
						...
						<div class="m-login__signin">
                            ...
                            <form id="login_form" class="m-login__form m-form" action="" runat="server">
										<div class="form-group m-form__group">
                                            <asp:TextBox ID="txtCompanyCode" runat="server" class="form-control m-input" type="text" placeholder="Enter your Company Code" autocomplete="off" ></asp:TextBox>
                                            <span id="error_txtCompanyCode" class="small text-danger"></span>
										</div>
                                        ...
                                        <asp:Button ID="m_login_signin_submit1" runat="server" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air" OnClick="btnCompany_Code" Text="Submit" />
                                        </div>
									</form>
