...
Public Class FrmDiscSummaryDaywise
    ...
    Private Sub btnok_Click(sender As System.Object, e As System.EventArgs) Handles btnok.Click
        Try
            ...
            ObjCls.FoodCostPerc = txtFoodCostPerc.Text
            ObjCls.BevCostPerc = txtBevCostPerc.Text
            ObjCls.LiqCostPerc = txtLiquorCost.Text
            ObjCls.UserName = gblUserName
            ObjPriDt = ObjCls.FunFetchDiscSummaryDaywise()
    ...
    Private Sub btnCrystalReport_Click(sender As System.Object, e As System.EventArgs) Handles btnCrystalReport.Click
        ...
        GenerateReport("discdaywise", "proc#" & "Spr_FetchDiscSummaryDaywise" & "#" & StrParam)
    End Sub

    Private Sub FrmDiscSummaryDaywise_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        BindEvalLicense()
    End Sub
