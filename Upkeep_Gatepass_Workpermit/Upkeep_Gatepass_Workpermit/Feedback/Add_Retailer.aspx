<%@ Page Title="" Language="C#" MasterPageFile="~/UpkeepMaster.Master" AutoEventWireup="true" CodeBehind="Add_Retailer.aspx.cs" Inherits="Upkeep_Gatepass_Workpermit.Feedback.Add_Retailer" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                    <%--<form class="m-form m-form--label-align-left- m-form--state-" id="retailer_form" method="post" runat="server">--%>
                                        ...
                                        <div class="m-form__section m-form__section--first">
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-6 col-lg-9">
                                                    ...
                                                    <asp:TextBox ID="email" runat="server" class="form-control m-input" ClientIDMode="Static" placeholder="Enter Email ID"></asp:TextBox>
