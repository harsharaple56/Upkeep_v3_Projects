...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div class="m-grid__item m-grid__item--fluid m-wrapper">
          ...
          <div class="row">
        <div class="col-xl-6 m-content" style="padding: 10px 10px;">
            <div class="m-portlet m-portlet--mobile">
                <div class="m-portlet__head">
                    ...
                    <div class="col-xl-12" style="text-align: center; max-width: 74%;     padding-right: 0px;">
        ...
        <div class="col-xl-6 m-content" style="padding: 10px 10px;">
            <div class="m-portlet m-portlet--mobile">
                <div class="m-portlet__head">
                    ...
                    <div class="col-xl-12" style="text-align: center; max-width: 74%;">
                        <a href="<%= Page.ResolveClientUrl("~/Laundry_Management/Stock_Setup/Setup.aspx") %>" style="margin-top: 5%;" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                            <span>
                                <i class="la la-backward"></i>
                                <span>Back</span>
                ...
                <div class="m-portlet__body">
                    ...
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_2" width="100%">
                        <thead>
                            <tr>
