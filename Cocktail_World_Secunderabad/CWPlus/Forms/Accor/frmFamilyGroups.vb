...
#Region "Procedures"
    ...
    Public Function Save() As Boolean
        ...
        Else
            ...
            End If
        End If
        If txtFamilyGroupName.Text = "" Then
        ...
        Try
            ...
            ObjMenuItem.ItemName = txtFamilyGroupName.Text
...
#End Region
    ...
    Private Sub grdsize_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdDiscount.CellDoubleClick
        ...
        txtFamilyGroupName.Text = grdDiscount("ItemName", e.RowIndex).Value
