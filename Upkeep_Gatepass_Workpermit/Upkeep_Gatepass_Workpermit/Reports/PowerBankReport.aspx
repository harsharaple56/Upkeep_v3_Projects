<%@ Page Title="" Language="C#" MasterPageFile="~/UpkeepMaster.Master" AutoEventWireup="true" CodeBehind="PowerBankReport.aspx.cs" Inherits="Upkeep_Gatepass_Workpermit.Reports.PowerBankReport" %>
                    ...
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text">Power Bank Report		
                                </h3>
                            </div>
                        </div>
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th title="Cable Type" data-field="CableType">Cable Type</th>
