...
Public Class FrmDCC_REPORT
    ...
    Private Sub btnCrystalReport_Click(sender As System.Object, e As System.EventArgs) Handles btnCrystalReport.Click
        ...
        GenerateReport("dccreportv2", "proc#" & "Spr_FetchDCCReport" & "#" & StrParam & "#100")
    End Sub
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        ...
        GenerateReport("topsheet", "proc#" & "Spr_FetchTopSheet" & "#" & StrParam & "#100")
    End Sub

    Private Sub btnCoverStmt_Click(sender As System.Object, e As System.EventArgs) Handles btnCoverStmt.Click
        Dim StrParam As String = ""
        StrParam = "'" & Format(DtFromDate.Value, "dd-MMM-yyyy") & "','" & Format(DtToDate.Value, "dd-MMM-yyyy") & "','" & gblUserName & "',''"
        GenerateReport("coverstmt", "proc#" & "Spr_FetchCoverStatementReport" & "#" & StrParam & "#100")
    End Sub
