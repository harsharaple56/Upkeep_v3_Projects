<%@ Page Title="" Language="C#" MasterPageFile="~/UpkeepMaster.Master" AutoEventWireup="true" CodeBehind="WorkPermit_MIS.aspx.cs" Inherits="Upkeep_Gatepass_Workpermit.WorkPermit.WorkPermit_MIS" %>
...

                    {
                        field: "Status", title: "Status", template: function (e) {
                            var t =
                            {
                                ...
                                "Hold": { title: "Hold", class: " m-badge--danger" },
                                "Reject": { title: "Rejected", class: " m-badge--warning" },
                    ...
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text">Work Permit MIS Report	
                                </h3>
                            </div>
                        </div>
                        ...
                        <table class="m-datatable" id="html_table" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th title="Work Permit From Date" data-field="WPDate">Work Permit From Date</th>                             
                                    <th title="Work Permit To Date" data-field="WPDate">Work Permit To Date</th>
