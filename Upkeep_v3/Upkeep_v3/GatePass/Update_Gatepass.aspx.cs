...
{
    public partial class Update_Gatepass : System.Web.UI.Page
    {
                ...
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            data += "<tr><td> <a href='Returnable_Gatepass.aspx?TransactionID=" + TransactionID + "&MyAction=1' style='text-decoration: underline;' > " + TicketNo + " </a></td><td>" + GatePass_Title + "</td><td>" + Department + "</td><td>" + GP_Type + "</td><td>" + GatePassDate + "</td><td>" + RequestDate + "</td><td>" + Status + "</td><td>" + Created_By + "</td><td>" + Store + "</td></tr>";
