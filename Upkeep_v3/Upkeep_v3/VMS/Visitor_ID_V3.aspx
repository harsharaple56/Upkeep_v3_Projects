<%@ Page Title="" Language="C#" MasterPageFile="~/BlankMaster.Master" AutoEventWireup="true" CodeBehind="Visitor_ID_V3.aspx.cs" Inherits="Upkeep_v3.VMS.Visitor_ID_V3" %>
    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        <div class="m-content">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="m-portlet" style="border-radius: 25px;border: 2px solid #6c6d6b;">
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
                                <div class="m-portlet__head-title">
                                    ...
                                    <h3 class="m-portlet__head-text">Visitor Pass
                                    </h3>
                                </div>
                            </div>
                                ...
                                <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="m-stack--ver m-stack--tablet m-stack--demo m--align-center">
                                            ...
                                            <div class="m-stack__item m-stack__item--center m-stack__item--top m--align-center">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="m-stack m-stack--ver m-stack--general m-stack--demo">
                                                        <div class="m-stack__item m--align-center">
